...
export function Dashboard({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* AI Insights Summary - More compact */}
      {aiInsights && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-1 space-y-3">
          ...
          {/* Upcoming Deadlines - Limited to 2 */}
          <div className="card p-3">
          ...
          {/* AI Recommendations - Limited to 1 */}
          ...
          {aiInsights?.studyTechniqueSuggestions && (
            <div className="card p-3">
              ...
              <div className="space-y-1">
                {aiInsights.studyTechniqueSuggestions.slice(0, 1).map((suggestion: any, index: number) => (
